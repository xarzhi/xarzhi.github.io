...
| 类型   | 描述                | 范围                                                    | .NET 类型                                                    |
| :----- | :------------------ | :------------------------------------------------------ | :----------------------------------------------------------- |
| sbyte  | 8 位有符号整数类型  | -128 到 127                                             | [System.SByte](https://learn.microsoft.com/zh-cn/dotnet/api/system.sbyte) |
| byte   | 8 位无符号整数      | 0 到 255                                                | [ System.Byte](https://learn.microsoft.com/zh-cn/dotnet/api/system.byte) |
| short  | 16 位有符号整数类型 | -32,768 到 32,767                                       | [System.Int16](https://learn.microsoft.com/zh-cn/dotnet/api/system.int16) |
| ushort | 16 位无符号整数类型 | 0 到 65,535                                             | [System.UInt16](https://learn.microsoft.com/zh-cn/dotnet/api/system.uint16) |
| int    | 32 位有符号整数类型 | -2,147,483,648 到 2,147,483,647                         | [System.Int32](https://learn.microsoft.com/zh-cn/dotnet/api/system.int32) |
| uint   | 32 位无符号整数类型 | 0 到 4,294,967,295                                      | [System.UInt32](https://learn.microsoft.com/zh-cn/dotnet/api/system.uint32) |
| long   | 64 位有符号整数类型 | -9,223,372,036,854,775,808 到 9,223,372,036,854,775,807 | [System.Int64](https://learn.microsoft.com/zh-cn/dotnet/api/system.int64) |
| ulong  | 64 位无符号整数类型 | 0 到 18,446,744,073,709,551,615                         | [System.UInt64](https://learn.microsoft.com/zh-cn/dotnet/api/system.uint64) |
...
| 类型   | 描述              | 范围                            | **.NET 类型**                                                |
| :----- | :---------------- | :------------------------------ | :----------------------------------------------------------- |
| float  | 32 位单精度浮点型 | ±1.5 x 10^-45 至 ±3.4 x 10^38   | [System.Single](https://learn.microsoft.com/zh-cn/dotnet/api/system.single) |
| double | 64 位双精度浮点型 | ±5.0 × 10^−324 到 ±1.7 × 10^308 | [System.Double](https://learn.microsoft.com/zh-cn/dotnet/api/system.double) |
...
默认情况下，枚举成员的关联常数值为类型 `int`；它们从零开始，并按定义文本顺序递增 1。但 可以显式指定任何其他[整数数值](https://learn.microsoft.com/zh-cn/dotnet/csharp/language-reference/builtin-types/integral-numeric-types)类型作为枚举类型的基础类型。 还可以显式指定关联的常数值，如下面的示例所示：
