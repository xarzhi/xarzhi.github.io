...
`<Transition>`是一个内置组件，为**单个**元素或组件提供动画过渡效果。它在任意别的组件中都可以被使用，无需注册。
...
![image-20241024150810210](https://gitee.com/xarzhi/picture/raw/master/img/image-20241024150810210.png)
...
以上CSS类名都是以`v`开头的，当我们没有给`<Transition>`元素添加name属性，默认`name='v'`

当我们设置name属性时，CSS类名的前缀应该变为相应的name
