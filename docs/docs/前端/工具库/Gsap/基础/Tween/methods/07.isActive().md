...
<MyIframe height="450" style="width: 100%;" scrolling="no" title="check isActive()" src="https://codepen.io/2235762265/embed/ZYGzvNX?default-tab=result&theme-id=41164" frameborder="no" loading="lazy" allowtransparency="true" allowfullscreen="true">
</MyIframe>
