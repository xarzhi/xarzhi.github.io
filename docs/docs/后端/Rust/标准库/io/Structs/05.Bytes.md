...
通常通过在 reader 上调用 [`bytes`](https://www.rustwiki.org.cn/zh-CN/std/io/trait.Read.html#method.bytes) 来创建此结构体。 请参见 [`bytes`](https://www.rustwiki.org.cn/zh-CN/std/io/trait.Read.html#method.bytes) 的文档以获取更多详细信息。
