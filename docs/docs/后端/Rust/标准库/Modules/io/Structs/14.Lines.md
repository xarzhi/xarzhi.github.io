...
通常通过在 `BufRead` 上调用 [`lines`](https://www.rustwiki.org.cn/zh-CN/std/io/trait.BufRead.html#method.lines) 来创建此结构体。 请参见 [`lines`](https://www.rustwiki.org.cn/zh-CN/std/io/trait.BufRead.html#method.lines) 的文档以获取更多详细信息。
