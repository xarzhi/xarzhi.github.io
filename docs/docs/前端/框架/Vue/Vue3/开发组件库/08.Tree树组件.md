...
![image-20250716100847655](https://gitee.com/xarzhi/picture/raw/master/img/image-20250716100847655.png)

package/components/component.js
...
<template>
  <div class="t-tree">
    <t-tree-node v-for="node in props.data" :key="node.id" :node="node" />
  </div>
</template>
...
然后在 `packages/theme-chalk/components` 中创建 `tree.scss`，并在 `theme-chalk/index.scss` 中引入
...
![image-20250716100901874](https://gitee.com/xarzhi/picture/raw/master/img/image-20250716100901874.png)
...
![image-20250716100932069](https://gitee.com/xarzhi/picture/raw/master/img/image-20250716100932069.png)
...
```vue [tree-node.vue] {3,19,26,30,38-44}
<template>
  <div class="t-tree-node">
...
![image-20250716100948370](https://gitee.com/xarzhi/picture/raw/master/img/image-20250716100948370.png)
...
我们通常在业务中使用的时候是需要获取到选中节点的值的，那么我们接下来来实现这个功能。
...
![image-20250716101006671](https://gitee.com/xarzhi/picture/raw/master/img/image-20250716101006671.png)
