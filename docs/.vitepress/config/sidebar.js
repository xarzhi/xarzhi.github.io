			...
			items: [
				{
					...
					items: [
						...
						},
						{
							text: '内部插件',
							collapsed: true,
							items: getItems('/docs/前端/工具库/Gsap/基础/gsap/internal-plugins'),
						},
					],
				},
				{
					...
					items: [
						{
							text: '属性',
							collapsed: true,
							items: getItems('/docs/前端/工具库/Gsap/基础/Timeline/properties'),
						},
						{
							text: '方法',
							collapsed: true,
	...
	'/docs/后端/Rust/标准库': [
		{
			...
			items: [
				{
					text: 'prelude',
					link: '/docs/后端/Rust/标准库/Modules/prelude',
				},
				{
					text: 'option',
					link: '/docs/后端/Rust/标准库/Modules/option/index.md',
					collapsed: true,
					items: [
						{
							text: 'Structs',
							collapsed: true,
							items: getItems('/docs/后端/Rust/标准库/Modules/option/Structs'),
						},
						{
							text: 'Enums',
							collapsed: true,
							items: getItems('/docs/后端/Rust/标准库/Modules/option/Enums'),
						},
					],
				},
				{
					text: 'result',
					link: '/docs/后端/Rust/标准库/Modules/result/index.md',
					collapsed: true,
					items: [
						{
							text: 'Structs',
							collapsed: true,
							items: getItems('/docs/后端/Rust/标准库/Modules/result/Structs'),
						},
						{
							text: 'Enums',
							collapsed: true,
							items: getItems('/docs/后端/Rust/标准库/Modules/result/Enums'),
						},
					],
				},
				{
					text: 'fs',
					link: '/docs/后端/Rust/标准库/Modules/fs/index.md',
					collapsed: true,
					items: [
						{
							text: 'Structs',
							collapsed: true,
							items: getItems('/docs/后端/Rust/标准库/Modules/fs/Structs'),
						},
					],
				},
				{
					text: 'io',
					link: '/docs/后端/Rust/标准库/Modules/io/index.md',
					collapsed: true,
					items: [
						{
							text: 'Functions',
							collapsed: true,
							link: '/docs/后端/Rust/标准库/Modules/io/Functions',
						},
						{
							text: 'Structs',
							collapsed: true,
							items: getItems('/docs/后端/Rust/标准库/Modules/io/Structs'),
						},
						{
							text: 'Traits',
							collapsed: true,
							items: getItems('/docs/后端/Rust/标准库/Modules/io/Traits'),
						},
						{
							text: 'Modules',
							collapsed: true,
							items: getItems('/docs/后端/Rust/标准库/Modules/io/Modules'),
						},
						{
							text: 'Enums',
							collapsed: true,
							items: getItems('/docs/后端/Rust/标准库/Modules/io/Enums'),
						},
						{
							text: 'TypeDefinitions',
							collapsed: true,
							items: getItems('/docs/后端/Rust/标准库/Modules/io/TypeDefinitions'),
						},
					],
				},
				{
					text: 'iter',
					link: '/docs/后端/Rust/标准库/Modules/iter/index.md',
					collapsed: true,
					items: [
						{
							text: 'Functions',
							collapsed: true,
							link: '/docs/后端/Rust/标准库/Modules/iter/Functions',
						},
						{
							text: 'Structs',
							collapsed: true,
							items: getItems('/docs/后端/Rust/标准库/Modules/iter/Structs'),
						},
						{
							text: 'Traits',
							collapsed: true,
							items: getItems('/docs/后端/Rust/标准库/Modules/iter/Traits'),
						},
					],
				},
				// 		// {
				...
				// 		// 	collapsed: true,
				// 		// 	items: getItems('/docs/后端/Rust/Rust教程/标准库/Modules/path/结构体'),
				// 		// },
				// 		// {
				// 		// 	text: 'os',
				// 		// 	link: '/docs/后端/Rust/Rust教程/标准库/Modules/os',
				// 		// 	collapsed: true,
