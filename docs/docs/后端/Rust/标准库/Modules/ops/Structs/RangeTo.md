...
### impl Index\<RangeTo> for CString
...
```rust
fn index(&self, _index: RangeTo) -> &OsStr
```



### impl Index\<RangeTo> for OsString
...
```rust
fn index(&self, _index: RangeTo) -> &str
```



### impl IndexMut\<RangeTo> for OsString
...
```rust
fn index_mut(&mut self, _index: RangeTo) -> &mut OsStr
```



### impl IndexMut\<RangeTo> for String
...
```rust
fn index_mut(&mut self, _index: RangeTo) -> &mut str
```



### impl PartialEq\<RangeTo> for RangeTo\<Idx>
